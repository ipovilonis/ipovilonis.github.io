...
rownames(pca_result$rotation)[5] <- "DPPH125"
rownames(pca_result$rotation)[6] <- "DPPH250"
rownames(pca_result$rotation)[7] <- "DPPH500"
...
rownames(pca_result$rotation)[16] <- "Sólidos solubles/Acidez"
...
ggsave("biplot_almacenamiento.tiff", plot = biplot_almacenamiento, device = "tiff", width = 16, height = 8, units = "in", dpi = 300)
