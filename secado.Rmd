...
## Cantidad de gramos de PS por 6 gramos de PF
...
tamaño_efecto <- 1  # Tamaño del efecto esperado (debe especificarse si ya se sabe)
...
tamaño_efecto <- (media_1-media_2)/desviacion_estandar_ponderada
