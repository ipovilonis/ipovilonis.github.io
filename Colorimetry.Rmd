...
tdplot <-scatterplot3d(data[7:9],
                       ...
                       # type="h",
                       angle = 280)
legend("topleft", legend = unique(data$site), col = unique(colors), pch = 16, title = "Sites")
...
tdplot <-scatterplot3d(data[7:9],
                       ...
                       # type="h",
                       angle = 280)
legend("topleft", legend = unique(data$mad), col = unique(colors), pch = 16, title = "Maturity")
