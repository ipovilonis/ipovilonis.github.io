...
temp_month <- ggplot(table_temp, aes(x = month, y = temp, color = site, group = site)) +
  geom_smooth(method = "gam", se = FALSE, size = 2) +
  geom_smooth(aes(y = Mean_temp, color = site), linetype = 4, size = 1)+
  geom_hline(yintercept = 19.09166667, color = "coral2", linetype = "dashed", size = 1.5) +
  geom_hline(yintercept = 18.41666667, color = "burlywood3", linetype = "dashed", size = 1.5) +
