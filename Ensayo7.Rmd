...
library(readxl)
data<-read_excel("database.xlsx", sheet = "VI PosCord")
datasup<-data[,-(11:12)]
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = FALSE)
library(Rmisc)
estadPESO <- summarySE(dataPESO, measurevar="PESO", groupvars=c("DIA","TEMP"),na.rm = TRUE)

P3<- ggplot(estadPESO, aes(x=DIA, y=PESO, color=TEMP, group=TEMP)) +
...
data4<-read_excel("database.xlsx", sheet = "VI PesoSpread")
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = FALSE)
library(Rmisc)
estadL <- summarySE(data, measurevar="L", groupvars=c("DIA","TEMP"),na.rm = TRUE)
L3<-ggplot(estadL, aes(x=DIA, y=L, color=TEMP, group=TEMP)) +
  stat_summary(fun = "mean", size = 2, geom = "point") +
  scale_color_manual(values=c("cyan4", "coral1"))+
...
data4<-read_excel("database.xlsx", sheet = "VI ColorSpread")
library(dplyr)
data4<- data4 %>% dplyr::filter(VAR == "color_L")
data4$TEMP<-as.factor(data4$TEMP)
data4$ID<-as.factor(data4$ID)
attach(data4)
tiempos <-data4[4:8]
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = FALSE)
library(Rmisc)
estada <- summarySE(data, measurevar="a", groupvars=c("DIA","TEMP"),na.rm = TRUE)
a3<-ggplot(estada, aes(x=DIA, y=a, color=TEMP, group=TEMP)) +
  stat_summary(fun = "mean", size = 2, geom = "point") +
  scale_color_manual(values=c("cyan4", "coral1"))+
...
data4<-read_excel("database.xlsx", sheet = "VI ColorSpread")
library(dplyr)
data4<- data4 %>% dplyr::filter(VAR == "color_a")
data4$TEMP<-as.factor(data4$TEMP)
data4$ID<-as.factor(data4$ID)
attach(data4)
tiempos <-data4[4:8]
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = FALSE)
library(Rmisc)
estadb <- summarySE(data, measurevar="b", groupvars=c("DIA","TEMP"),na.rm = TRUE)
b3<-ggplot(estadb, aes(x=DIA, y=b, color=TEMP, group=TEMP)) +
  stat_summary(fun = "mean", size = 2, geom = "point") +
  scale_color_manual(values=c("cyan4", "coral1"))+
...
data4<-read_excel("database.xlsx", sheet = "VI ColorSpread")
library(dplyr)
data4<- data4 %>% dplyr::filter(VAR == "color_b")
data4$TEMP<-as.factor(data4$TEMP)
data4$ID<-as.factor(data4$ID)
attach(data4)
tiempos <-data4[4:8]
...
dataco<-read_excel("database.xlsx", sheet = "VI Compre")
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = FALSE)
library(emmeans)
Comp2<-emmeans(m2FU, pairwise ~ DIA, mode = "df.error")
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = FALSE)
library(emmeans)
Comp2<-emmeans(m2GR, pairwise ~ DIA, mode="df.error")
plot(Comp2, comparisons = TRUE)+theme_classic()+
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = FALSE)
library(emmeans)
Comp2<-emmeans(m2DI, pairwise ~ DIA, mode="df.error")
plot(Comp2, comparisons = TRUE)+theme_classic()+
...
```{r, echo=FALSE, fig.align='center', fig.asp=0.4}
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = FALSE)
datap<-read_excel("database.xlsx", sheet = "VI Puncion")
attach(datap)
...
databtg<-read_excel("database.xlsx", sheet = "VI BTG")

databtg$VR<-factor(databtg$VR, levels = c("PESO","L","a","b","FU"))
databtg$DIA<-as.factor(databtg$DIA)
databtg$TEMP<-as.factor(databtg$TEMP)

databtgPESO<-subset(databtg, VR == "PESO")
databtgL<-subset(databtg, VR == "L")
databtga<-subset(databtg, VR == "a")
databtgb<-subset(databtg, VR == "b")
databtgFU<-subset(databtg, VR == "FU")
...
FGPESO<-ggplot(data = databtgPESO, aes(x = DIA, y = MEAN, fill=TEMP))+
...
FGL<-ggplot(data = databtgL, aes(x = DIA, y = MEAN, fill=TEMP))+
  stat_summary(fun = "mean", size = 0.5, geom = "bar", position = "dodge2")+
  geom_errorbar(aes(ymin=MEAN-sd, ymax=MEAN+sd), width=0.2,position = position_dodge(1))+
...
FGa<-ggplot(data = databtga, aes(x = DIA, y = MEAN, fill=TEMP))+
  stat_summary(fun = "mean", size = 0.5, geom = "bar", position = "dodge2")+
  geom_errorbar(aes(ymin=MEAN-sd, ymax=MEAN+sd), width=0.2,position = position_dodge(1))+
...
FGb<-ggplot(data = databtgb, aes(x = DIA, y = MEAN, fill=TEMP))+
  stat_summary(fun = "mean", size = 0.5, geom = "bar", position = "dodge2")+
  geom_errorbar(aes(ymin=MEAN-sd, ymax=MEAN+sd), width=0.2,position = position_dodge(1))+
...
FGFU<-ggplot(data = databtgFU, aes(x = DIA, y = MEAN, fill=TEMP))+
  stat_summary(fun = "mean", size = 0.5, geom = "bar", position = "dodge2")+
  geom_errorbar(aes(ymin=MEAN-sd, ymax=MEAN+sd), width=0.2,position = position_dodge(1))+
  
  theme_classic()+
  scale_fill_manual(values=c("coral", "coral4"))+
  labs(y="Firmeza (N)", x="Días desde cosecha")+
  theme(legend.title=element_blank())+
  theme(legend.position = "bottom")+
  theme(panel.grid.major.y = element_line(size=0.5, color='black'))+
  theme(panel.grid.major.x = element_blank())+
...
FG1<-ggarrange(FGPESO,FGL,FGa,FGb,FGFU, ncol = 1,  common.legend = TRUE)
...
#   geom_jitter(se = FALSE, width = 0.3, size=5)+
...
#   labs(y="Descarte de frutos", x="Temperatura °C")+
#   theme(legend.title=element_blank())+
#   theme(legend.position = "bottom")+
#   theme(legend.background = element_rect(fill = "white"))+
#   theme(panel.grid.major.y = element_line(size=0.5, color='black'))+
...
datac0<-read_excel("database.xlsx", sheet = "VI Datac")
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = FALSE)
# data<-datac#[4:15,]
datac$DIA<-factor(datac$DIA,levels=c("0","7","14"))
datac$TEMP<-factor(datac$TEMP,levels=c("5", "9"))

library(Rmisc)
estadph <- summarySE(datac, measurevar="pH", groupvars=c("DIA","TEMP"),na.rm = TRUE)
...
library(emmeans)
Comp2<-emmeans(m1PH, pairwise ~ DIA, mode="df.error")
...
library(Rmisc)
estadSS <- summarySE(datac, measurevar="SS", groupvars=c("DIA","TEMP"),na.rm = TRUE)
...
library(Rmisc)
estadac <- summarySE(datac, measurevar="Ac", groupvars=c("DIA","TEMP"),na.rm = TRUE)
...
library(readxl)
fisico59<-read_excel("database.xlsx", sheet = "VI PosCord")
quimico59<-read_excel("database.xlsx", sheet = "VI Datac")
quimico59$SSATT <- quimico59$SS/quimico59$Ac
fisico59$DIA<-as.factor(fisico59$DIA)
fisico59$TEMP<-as.factor(fisico59$TEMP)
quimico59$DIA<-as.factor(quimico59$DIA)
quimico59$TEMP<-as.factor(quimico59$TEMP)
...
library(dplyr)
table_SSATT <- quimico59 %>%
  dplyr::group_by(DIA, TEMP) %>%
  dplyr::summarise(mean = mean(SSATT),
                   sd = sd(SSATT))
...
model_SSATT <- lm(SSATT ~ TEMP*DIA, data = quimico59)
...
residuos <- residuals(model_SSATT)       # Residuos del modelo
predichos <- fitted(model_SSATT)         # Valores predichos
library(ggplot2)
...
levene_test <- leveneTest(SSATT ~ TEMP, data = quimico59)
print(levene_test)
levene_test <- leveneTest(SSATT ~ DIA, data = quimico59)
print(levene_test)
...
residuos_std <- rstandard(model_SSATT)
...
library(emmeans)
comp_resp5<-emmeans(model_SSATT, pairwise ~ TEMP*DIA)
comp_resp5
...
databtg<-read_excel("database.xlsx", sheet = "VI BTG2")

databtg$VR<-factor(databtg$VR, levels = c("pH","SS","acidez"))
databtg$DIA<-as.factor(databtg$DIA)
databtg$TEMP<-as.factor(databtg$TEMP)

databtgpH<-subset(databtg, VR == "pH")
databtgSS<-subset(databtg, VR == "SS")
databtgacidez<-subset(databtg, VR == "acidez")
...
FGpH<-ggplot(data = databtgpH, aes(x = DIA, y = MEAN, fill=TEMP))+
  stat_summary(fun = "mean", size = 0.5, geom = "bar", position = "dodge2")+
  geom_errorbar(aes(ymin=MEAN-sd, ymax=MEAN+sd), width=0.2,position = position_dodge(1))+
...
FGSS<-ggplot(data = databtgSS, aes(x = DIA, y = MEAN, fill=TEMP))+
  stat_summary(fun = "mean", size = 0.5, geom = "bar", position = "dodge2")+
  geom_errorbar(aes(ymin=MEAN-sd, ymax=MEAN+sd), width=0.2,position = position_dodge(1))+
...
FGacidez<-ggplot(data = databtgacidez, aes(x = DIA, y = MEAN, fill=TEMP))+
  stat_summary(fun = "mean", size = 0.5, geom = "bar", position = "dodge2")+
  geom_errorbar(aes(ymin=MEAN-sd, ymax=MEAN+sd), width=0.2,position = position_dodge(1))+
  theme_classic()+
  scale_fill_manual(values=c("coral", "coral4"))+
  labs(y="ATT ((g/100mL)", x="")+
  theme(legend.title=element_blank())+
  theme(legend.position = "none")+
  theme(panel.grid.major.y = element_line(size=0.5, color='black'))+
  theme(panel.grid.major.x = element_blank())+
...
FG2<-ggarrange(FGpH,FGSS,FGacidez, ncol = 1,  common.legend = TRUE)
...
nggPESO<-ggplot(data, aes(x = TEMP, y = PESO, fill=TEMP)) +
  ggdist::stat_halfeye(
    adjust = .5,
    width = .6,
    .width = 0,
...
nggL<-ggplot(data, aes(x = TEMP, y = L, fill=TEMP)) +
  ggdist::stat_halfeye(
    adjust = .5,
    width = .6,
    .width = 0,
...
ngga<-ggplot(data, aes(x = TEMP, y = a, fill=TEMP)) +
  ggdist::stat_halfeye(
    adjust = .5,
    width = .6,
    .width = 0,
...
nggb<-ggplot(data, aes(x = TEMP, y = b, fill=TEMP)) +
  ggdist::stat_halfeye(
    adjust = .5,
    width = .6,
    .width = 0,
...
nggFU<-ggplot(dataco, aes(x = TEMP, y = FU, fill=TEMP)) +
  ggdist::stat_halfeye(
    adjust = .5,
    width = .6,
    .width = 0,
...
nggph<-ggplot(datac, aes(x = TEMP, y = pH, fill=TEMP)) +
  ggdist::stat_halfeye(
    adjust = .5,
    width = .6,
    .width = 0,
...
nggSS<-ggplot(datac, aes(x = TEMP, y = SS, fill=TEMP)) +
  ggdist::stat_halfeye(
    adjust = .5,
    width = .6,
    .width = 0,
...
nggAc<-ggplot(datac, aes(x = TEMP, y = Ac, fill=TEMP)) +
  ggdist::stat_halfeye(
    adjust = .5,
    width = .6,
    .width = 0,
...
FG3<-ggarrange(nggPESO,nggFU, ncol = 1,  common.legend = TRUE)
FG4<-ggarrange(nggL,ngga,nggb, ncol = 1,  common.legend = TRUE)
FG5<-ggarrange(nggph,nggSS,nggAc, ncol = 1,  common.legend = TRUE)
