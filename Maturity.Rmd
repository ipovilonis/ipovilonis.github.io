...
library(ggplot2)
galmi2<-ggplot2::ggplot(estalmi, aes(x=MAD, y=STARCHs, color=MAD, width=1))+
  stat_summary(fun = "mean", size = 6, geom = "point") +
...
library(ggplot2)
galmi3<-ggplot2::ggplot(ALMI, aes(x=MAD, y=STARCHs, color=MAD, width=1))+
  geom_point(size=9)+
  scale_color_manual(values=c("palegreen4","green2","orange","burlywood2"))+
  labs(y="g almidon/100 g fruta fresca", x="Madurez")+
  theme_classic()+
...
CompSTARCHs
plot(CompSTARCHs, comparisons = TRUE) + theme_classic() + 
  labs(x = "Concentración", y ="Madurez" )+
  theme_classic()+
  theme(legend.position = "bottom", legend.background = element_rect(fill = "gray12"))+
