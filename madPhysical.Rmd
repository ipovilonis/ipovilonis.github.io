...
library(knitr)
kable(tablas_list$PFF, format = "markdown")
...
plot(Comp_PFF_mad, comparisons = TRUE) + theme_classic() + 
  labs(x = "Peso fresco del fruto (g)", y ="madurez" )
...
kable(tablas_list$PSF, format = "markdown")
...
plot(Comp_PSF_mad, comparisons = TRUE) + theme_classic() + 
  labs(x = "Peso seco del fruto (g)", y ="madurez" )
```
...
kable(tablas_list$H, format = "markdown")
...
kable(tablas_list$Dem, format = "markdown")
...
plot(Comp_Dem_mad, comparisons = TRUE)+ 
  labs(x = "Diámetro ecuatorial menor (mm)", y ="madurez" )
```
...
Comp_DeM_mad
plot(Comp_DeM_mad, comparisons = TRUE)+ 
  labs(x = "Diámetro ecuatorial mayor (mm)", y ="madurez" )
```
...
kable(tablas_list$DP, format = "markdown")
...
plot(Comp_DP_mad, comparisons = TRUE)+ 
  labs(x = "Diámetro polar (mm)", y ="madurez" )
```
...
kable(tablas_list$PSS, format = "markdown")
...
plot(Comp_PSS_mad, comparisons = TRUE)+ 
  labs(x = "Peso seco semillas (g)", y ="madurez" )
```
...
kable(tablas_list$PSSPSF, format = "markdown")
...
graficos_list$PSSPSF +
  ylab("Peso seco semilla/Peso seco fruto")
...
plot(Comp_PSSPSF_mad, comparisons = TRUE)+ 
  labs(x = "Peso seco semilla/Peso seco fruto", y ="madurez" )
```
...
```
 ...
 Tabla descriptiva color_L
```{r  , echo=FALSE, fig.align='center', fig.asp=0.4, fig.width=10, fig.height=8}
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = FALSE)

kable(tablas_list_color$color_L, format = "markdown")
...
## Color *a
 Tabla descriptiva color_a
```{r  , echo=FALSE, fig.align='center', fig.asp=0.4, fig.width=10, fig.height=8}
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = FALSE)

kable(tablas_list_color$color_a, format = "markdown")
...
## Color *b
 Tabla descriptiva color_b
```{r  , echo=FALSE, fig.align='center', fig.asp=0.4, fig.width=10, fig.height=8}
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = FALSE)

kable(tablas_list_color$color_b, format = "markdown")
