...
UbCites <- data.frame(
  cite = cite_labels,
  lat = c(sitesH$latitude, sitesF$latitude),
  lng = c(sitesH$longitude, sitesF$longitude)
)
...
```
Mapa con los sitios de recolección de las muestras de H. edulis. Los círculos verdes representan muestras recolectadas de poblaciones silvestres y los cuadrados amarillos muestran material de herbarios o poblaciones no silvestres.
...
#     pattern_fill = "blue", # Color del patrón
