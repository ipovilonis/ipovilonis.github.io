...
resp$time_interval <- as.factor(resp$time_interval)
...
library(ggplot2)
grespbp <- ggplot(data = resp, aes(x = matu, y = carbon_mg, fill=matu, group=matu))+
...
mresp <- lme(carbon_mg ~ matu, random = ~ 1|rep,
