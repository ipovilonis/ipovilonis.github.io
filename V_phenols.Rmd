...
data_phenols$site<-factor(data_phenols$site, levels = c("Concordia", "PN El Palmar", "Gualeguaychú"))
...
# palmar_phenols<-subset(data_phenols, site == "PN El Palmar")
# 
# library(dplyr)
...
#                 width=.2, position=position_dodge(.9))+
#   facet_grid(.~year)+
#   labs(x="PN El Palmar", y="Phenols [mgTA/100gFW]")+
#   theme_classic()+
#   theme(plot.title = element_text(hjust = 0.5, size = rel(1.5))) +
#   theme(legend.title=element_blank())+
#   theme(legend.position='none')+
...
# guale_phenols<-subset(data_phenols, site == "Gualeguaychú")
# 
# library(dplyr)
