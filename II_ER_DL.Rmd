...
|------|---------------|--------------------|----------------------|
|    2019 | Concordia     |      19,7±1,6b     | 69,2±2,5ab           |
...
data_dl$temp2<-data_dl$temp+2 # to avoid negaive numbers in gamma models

library(lme4)
modelo_dl_temp <- lmer(temp~year*site+(1|hour), data = data_dl)
...
# 
# #Tukey por default
# comp1<-emmeans(modelo_dl_temp_gamma_log_mixto, pairwise ~ site*year, type="response")
# comp1
...
efsimple_dl<-emmeans(modelo_dl_hr_beta_mixto, pairwise ~ site | year,  type="response") #Tukey por default
efsimple_dl
